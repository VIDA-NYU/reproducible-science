...
BLOG_AUTHOR = "NYU Reproducibility WG"  # (translatable)
...
# (translatable)
CONTENT_FOOTER = '{date} <a href="mailto:{email}">{author}</a> | <a href="https://github.com/vida-nyu/reproducible-science"><i class="fab fa-github"></i></a> <a href="https://twitter.com/ReproFeed"><i class="fab fa-twitter"></i></a> <a href="https://vida-nyu.github.io/reproducibility-news/feed.rss"><i class="fas fa-rss"></i></a>'
...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-74828384-1"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-74828384-1');
</script>
'''
